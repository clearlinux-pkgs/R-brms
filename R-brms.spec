...
Version  : 2.11.1
Release  : 43
URL      : https://cran.r-project.org/src/contrib/brms_2.11.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/brms_2.11.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579628530
...
/usr/lib64/R/library/brms/tests/testthat/tests.pp_expect.R
