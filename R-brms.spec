...
Version  : 2.13.5
Release  : 50
URL      : https://cran.r-project.org/src/contrib/brms_2.13.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/brms_2.13.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596207959
